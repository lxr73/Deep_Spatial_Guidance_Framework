"""Public demo of the dynamic experimental workflow.

Some implementation details are not publicly available.
"""
...
def dist1(q1, q2):
    ...
    raise NotImplementedError("This implementation is not publicly available.")
